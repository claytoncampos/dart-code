//Funções
A maioria dos códigos existem trechos repetidos, para evitar isso criamos funções. 
Existem algumas formas para criarmos as funções, veja o código a seguir:
